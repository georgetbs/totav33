...
const BASE_URL = "https://bm.ge";

export default async function handler(req, res) {
  const categoryPaths = {
    economics: '/category/ekonomika',
    business: '/category/biznesi',
  };
  ...
  for (const currentCategory of categoriesToProcess) {
    ...
    try {
      ...
      const newsItems = $("div.flex.flex-col.col-span-4.lg\\:col-span-1.gap-y-2")
        ...
        .slice(0, 9); // Установка максимального количества новостей для каждой категории

...
const BASE_URL = "https://bm.ge/ru";

export default async function handler(req, res) {
  const categoryPaths = {
    economicsRu: '/category/Экономика',
    businessRu: '/category/business',
  };
  ...
  for (const currentCategory of categoriesToProcess) {
    ...
    try {
      ...
      const newsItems = $("div.flex.flex-col.col-span-4.lg\\:col-span-1.gap-y-2")
        ...
        .slice(0, 5); // Установка максимального количества новостей для каждой категории
